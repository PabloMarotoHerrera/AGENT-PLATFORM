...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Graphify | `0_architecture/governance/agent_platform_graphify_repo_map_summary.md`; `graphify-out/`; `9_artifacts/` | `present_metadata_document_only`; `graphify-out/` `not_present`; `9_artifacts/` `present_path_not_inspected` | `repository_graph_candidate`; `evidence_graph_candidate`; `architecture_map_candidate`; `generated_evidence_tool_candidate` | `candidate_only`; `not_adopted`; `not_executed`; `not_runtime` | Metadata classification and Graphify Repo Map Summary citation. | Source of truth, authority, automatic rerun, repo writer, raw output inspection, substrate selection. | P8.6 for read-only evidence boundary; future exact gate for rerun remains blocked. | Generated supporting evidence only. |
...
| --- | --- | --- | --- | --- | --- | --- |
| Graphify | `graphify-out/`; `9_artifacts/`; Graphify Repo Map Summary | `9_artifacts/`; `0_architecture/governance/agent_platform_graphify_repo_map_summary.md` | `graphify-out/` | Curated summary present; raw output path absent; artifact root present. | Summary metadata inspected; `9_artifacts/` contents not inspected. | Presence does not imply Graphify adoption. |
