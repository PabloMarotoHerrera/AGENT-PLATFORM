...
class ProviderModelPolicy(_ProviderRuntimeModel):
    """Selected model identity and replacement posture for P15.2."""
...
class ProviderTimeoutPolicy(_ProviderRuntimeModel):
    """Maximum provider-runtime timeout values owned by P15.2."""
...
class ProviderRuntimeProfile(_ProviderRuntimeModel):
    """Public immutable P15.2 OpenAI Codex provider-runtime profile."""
