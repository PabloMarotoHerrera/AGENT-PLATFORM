...
DASHBOARD_ENVIRONMENT_POLICY_ID = "runtime.environment.hermes.dashboard.experimental.v1"
TEST_WORKSPACE_POLICY_ID = "runtime.workspace.test.lifecycle_probe.v1"
DASHBOARD_WORKSPACE_POLICY_ID = "runtime.workspace.hermes.dashboard.experimental.v1"
TEST_READINESS_POLICY_ID = "runtime.readiness.test.lifecycle_probe.v1"
DASHBOARD_READINESS_POLICY_ID = "runtime.readiness.hermes.dashboard.experimental.v1"
TEST_SHUTDOWN_POLICY_ID = "runtime.shutdown.test.lifecycle_probe.v1"
DASHBOARD_SHUTDOWN_POLICY_ID = "runtime.shutdown.hermes.dashboard.experimental.v1"
DASHBOARD_FILES_ROOT_POLICY_ID = "runtime.files.hermes.dashboard.locked.v1"
...
class RuntimeArgumentSelector(StrEnum):
    ...
    HERMES_DASHBOARD_EXPERIMENTAL = "hermes_dashboard_experimental"
...
def _build_profiles() -> tuple[RuntimeProfileDefinition, ...]:
    profiles = (
        ...
        RuntimeProfileDefinition(
            profile_ref=RuntimeProfileRef(
                profile_id=HERMES_DASHBOARD_EXPERIMENTAL_PROFILE_ID,
                profile_class=RuntimeProfileClass.HERMES_DASHBOARD_EXPERIMENTAL,
            ...
            executable_selector=RuntimeExecutableSelector.CURRENT_PRODUCT_PYTHON,
            argument_selector=RuntimeArgumentSelector.HERMES_DASHBOARD_EXPERIMENTAL,
...
def _validate_profiles(profiles: tuple[RuntimeProfileDefinition, ...]) -> None:
    ...
    for profile in profiles:
        ...
        if profile_ref.profile_class is RuntimeProfileClass.TEST_LIFECYCLE_PROBE:
            ...
            is RuntimeProfileClass.HERMES_DASHBOARD_EXPERIMENTAL
        ):
...
def _validate_dashboard_profile(profile: RuntimeProfileDefinition) -> None:
    if profile.profile_ref.profile_id != HERMES_DASHBOARD_EXPERIMENTAL_PROFILE_ID:
        raise InvalidRuntimeProfileDefinitionError(
            validation_category="dashboard_profile_id"
        )
    if (
        profile.argument_selector
        is not RuntimeArgumentSelector.HERMES_DASHBOARD_EXPERIMENTAL
    ):
        raise InvalidRuntimeProfileDefinitionError(
