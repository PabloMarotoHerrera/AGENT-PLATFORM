"""Validated, credential-free Pepper product configuration."""
...
class ProductConfiguration(BaseModel):
    """Safe product metadata consumed by Pepper UI surfaces."""
...
def load_product_configuration() -> ProductConfiguration:
    ...
    P15.M6 deliberately has no environment, user-config, managed-scope or
