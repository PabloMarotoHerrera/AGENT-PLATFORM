...
def cmd_agent_platform(args):
    """Manage Pepper agent-platform governance."""
    from hermes_cli.agent_platform.auth_commands import agent_platform_command

    return agent_platform_command(args)
...
def main():
    ...
    # =========================================================================
    # agent-platform command  (parser built in hermes_cli/subcommands/agent_platform.py)
    # =========================================================================
    build_agent_platform_parser(subparsers, cmd_agent_platform=cmd_agent_platform)
